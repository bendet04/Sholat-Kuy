...
import id.bhinneka.sholatkuy.adapter.AdapterPrayerSchedule
...
class SchedulePrayerActivity: AppCompatActivity(){
    ...
    private fun doLoadData(){
        ...
        text_view_location_city_activity_prayer_scedule.text = locationCity
        text_view_date_activity_prayer_schedule.text = SimpleDateFormat(
                "HH:mm EEE, MM MM d, yyyy", Locale.US).format(Date())
